...
0
|| checktplrefresh('./template/default/home/spacecp_pm.htm', './template/default/common/seditor.htm', 1658249016, '1', './data/template/1_1_home_spacecp_pm.tpl.php', './template/default', 'home/spacecp_pm')
|| checktplrefresh('./template/default/home/spacecp_pm.htm', './template/default/common/seditor.htm', 1658249016, '1', './data/template/1_1_home_spacecp_pm.tpl.php', './template/default', 'home/spacecp_pm')
|| checktplrefresh('./template/default/home/spacecp_pm.htm', './template/default/common/seditor.htm', 1658249016, '1', './data/template/1_1_home_spacecp_pm.tpl.php', './template/default', 'home/spacecp_pm')
|| checktplrefresh('./template/default/home/spacecp_pm.htm', './template/default/home/space_prompt_nav.htm', 1658249016, '1', './data/template/1_1_home_spacecp_pm.tpl.php', './template/default', 'home/spacecp_pm')
...
<h3 class="flb">
<em id="return_<?php echo $_GET['handlekey'];?>">Delete short message</em>
...
<div class="c">Are you sure you want to delete all private text messages with this user?</div>
<p class="o pns">
<button type="submit" name="deletesubmit_btn" value="true" class="pn pnc"><strong>Sure</strong></button>
</p>
</form>
</div>
...
<input type="hidden" name="deletesubmit" value="true" />
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<div class="c">Are you sure you want to delete this group chat message?</div>
<p class="o pns">
<button type="submit" name="deletesubmit_btn" value="true" class="pn pnc"><strong>Sure</strong></button>
</p>
</form>
...
<input type="hidden" name="deletesubmit" value="true" />
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<div class="c">Are you sure you want to leave this group chat message?</div>
<p class="o pns">
<button type="submit" name="deletesubmit_btn" value="true" class="pn pnc"><strong>Quit</strong></button>
</p>
</form>
</div>
...
<input type="hidden" name="deletesubmit" value="true" />
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<div class="c">Are you sure you want to delete this short message?</div>
<p class="o pns">
<button type="submit" name="deletesubmit_btn" value="true" class="pn pnc"><strong>Sure</strong></button>
</p>
</form>
...
<input type="hidden" name="deletesubmit" value="true" />
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<div class="c">Are you sure you want to delete this public short message?</div>
<p class="o pns">
<button type="submit" name="deletesubmit_btn" value="true" class="pn pnc"><strong>Sure</strong></button>
</p>
</form>
...
<h3 class="flb">
<em id="return_<?php echo $_GET['handlekey'];?>">Short message report</em>
<?php if($_G['inajax']) { ?><span><a href="javascript:;" onclick="hideWindow('<?php echo $_GET['handlekey'];?>');" class="flbc" title="Closure">Closure</a></span><?php } ?>
</h3>
<div id="<?php echo $pmid;?>">
...
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<div class="c">Are you sure you want to report this short message?</div>
<p class="o pns">
<button type="submit" name="pmreportsubmit_btn" value="true" class="pn pnc"><strong>Sure</strong></button>
</p>
</form>
</div>
...
<h3 class="flb">
<em id="return_<?php echo $_GET['handlekey'];?>">Neglect</em>
<?php if($_G['inajax']) { ?><span><a href="javascript:;" onclick="hideWindow('<?php echo $_GET['handlekey'];?>');" class="flbc" title="Closure">Closure</a></span><?php } ?>
</h3>
<div id="<?php echo $plid;?>">
...
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<div class="c">Are you sure you want to add this user to the ignore list?</div>
<p class="o pns">
<button type="submit" name="pmignoresubmit_btn" value="true" class="pn pnc"><strong>Sure</strong></button>
</p>
</form>
</div>
...
<h3 class="flb">
<em id="return_<?php echo $_GET['handlekey'];?>">Kick out</em>
<?php if($_G['inajax']) { ?><span><a href="javascript:;" onclick="hideWindow('<?php echo $_GET['handlekey'];?>');" class="flbc" title="Closure">Closure</a></span><?php } ?>
</h3>
...
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<div class="c">Are you sure you want to kick this user out of the group chat?</div>
<p class="o pns">
<button type="submit" name="pmkickmembersubmit_btn" value="true" class="pn pnc"><strong>Sure</strong></button>
</p>
</form>
</div>
...
<h3 class="flb">
<em id="return_<?php echo $_GET['handlekey'];?>">Join in</em>
<?php if($_G['inajax']) { ?><span><a href="javascript:;" onclick="hideWindow('<?php echo $_GET['handlekey'];?>');" class="flbc" title="Closure">Closure</a></span><?php } ?>
</h3>
<div id="appendmember">
...
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<div class="c">Are you sure you want to add this user to the group chat?</div>
<p class="o pns">
<button type="submit" name="pmappendmembersubmit_btn" value="true" class="pn pnc"><strong>Sure</strong></button>
</p>
</form>
</div>
...
<h3 class="flb">
<em id="return_<?php echo $_GET['handlekey'];?>">Shield<?php echo $username;?></em>
<?php if($_G['inajax']) { ?><span><a href="javascript:;" onclick="hideWindow('<?php echo $_GET['handlekey'];?>');" class="flbc" title="Closure">Closure</a></span><?php } ?>
</h3>
...
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<div class="c">Are you sure you want to block this user?</div>
<p class="o pns">
<button type="submit" name="deletesubmit_btn" value="true" class="pn pnc"><strong>Sure</strong></button>
</p>
</form>
...
<div class="pm">
<h3 class="flb">
<em>Chatting with <?php echo $msguser;?>...<?php if($online) { ?>[Online]<?php } else { ?>[Offline]<?php } ?></em>
<?php if($_G['inajax']) { ?><span><a href="javascript:;" onclick="hideWindow('<?php echo $_GET['handlekey'];?>');" class="flbc" title="Closure">Closure</a></span><?php } ?>
</h3>
<div class="pm_tac bbda cl">
<a href="home.php?mod=space&amp;do=pm&amp;subop=view&amp;touid=<?php echo $touid;?>#last" class="y" target="_blank">View chat history with <?php echo $msguser;?></a>
<a href="home.php?mod=space&amp;uid=<?php echo $touid;?>" target="_blank">Visit <?php echo $msguser;?>'s space</a>
</div>
<div class="c">
...
<div class="mtn pns cl">
 					<button type="submit" class="pn pnc" id="pmsubmit_btn"><strong>Send</strong></button>
 					<div class="pma mtn z">
<a href="javascript:;" title="Refresh" onclick="refreshMsg();"><img src="<?php echo IMGDIR;?>/pm-ico5.png" alt="Refresh" class="vm" /> Refresh</a>
 					</div>
</div>
</form>
...
<h1 class="mt"><img class="vm" src="<?php echo STATICURL;?>image/feed/pm.gif" alt="send pm" /> Send a message</h1>
<ul class="tb cl">
<li class="y"><a href="home.php?mod=space&amp;do=pm&amp;view=inbox" class="xi2">Back to message list</a></li>
<li<?php if(!$type) { ?> class="a"<?php } ?>><a href="home.php?mod=spacecp&amp;ac=pm">Private message</a></li>
<li<?php if($type == 1) { ?> class="a"<?php } ?>><a href="home.php?mod=spacecp&amp;ac=pm&amp;type=1">Group chat</a></li>
</ul>
<?php } else { ?>
<h3 class="flb">
<em id="return_<?php echo $_GET['handlekey'];?>">Send a message</em>
<?php if($_G['inajax']) { ?><span><a href="javascript:;" onclick="hideWindow('<?php echo $_GET['handlekey'];?>');" class="flbc" title="Closure">Closure</a></span><?php } ?>
</h3>
<?php } if(!$type) { ?>
...
<?php if(!$touid) { ?>
<tr>
<th><label for="username">Recipient:</label></th>
<td>
<div class="cl">
<div class="un_selector px z cl" onclick="$('username').focus();">
<input type="text" name="username" id="username" autocomplete="off" />
</div>
<a href="javascript:;" id="showSelectBox" class="z mtn xi2 showmenu" onclick="showMenu({'showid':this.id, 'duration':3, 'pos':'34!'});fs.showPMFriend('showSelectBox_menu','selectorBox', this);" title="Choose from friends list">Select friend</a>
</div>
...
<?php } ?>
<tr>
<th><label for="sendmessage">Content:</label></th>
<td>
<div class="tedt">
...
<p class="o pns">
<button type="submit" name="pmsubmit_btn" id="pmsubmit_btn" value="true" class="pn pnc"><strong>Send</strong></button>
</p>
<?php } else { ?>
<tr>
<th>&nbsp;</th>
...
<tr>
<th><label for="username">Participant:</label></th>
<td>
<div class="cl">
<div class="un_selector px z cl" onclick="$('username').focus();">
<input type="text" name="username" id="username" autocomplete="off" />
