...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1658248453, '1', './data/template/1_1_common_header_home_spacecp.tpl.php', './template/default', 'common/header_home_spacecp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1658248453, '1', './data/template/1_1_common_header_home_spacecp.tpl.php', './template/default', 'common/header_home_spacecp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1658248453, '1', './data/template/1_1_common_header_home_spacecp.tpl.php', './template/default', 'common/header_home_spacecp')
;?>
...
<div class="xi1 bm bm_c">
    Please choose <a href="<?php echo $_G['siteurl'];?>forum.php?mobile=yes">Enter the mobile version</a> <span class="xg1">|</span> <a href="<?php echo $_G['setting']['mobile']['nomobileurl'];?>">Continue to the PC version</a>
</div>
...
You visit <?php echo $_G['setting']['bbname'];?> often, try adding it to your desktop for easier access!
<a href="javascript:;" id="shortcuttip">Add <?php echo $_G['setting']['bbname'];?> to desktop</a>
...
<div class="y">
<a id="switchblind" href="javascript:;" onclick="toggleBlind(this)" title="Enable Assisted Access" class="switchblind"></a>
...
<a href="javascript:;" id="switchwidth" onclick="widthauto(this)" title="<?php if(widthauto()) { ?>Switch to narrow version<?php } else { ?>Switch to wide<?php } ?>" class="switchwidth"><?php if(widthauto()) { ?>Switch to narrow version<?php } else { ?>Switch to wide<?php } ?></a>
<?php } if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});">Switch style</a><?php } if(check_diy_perm($topic)) { ?>
<?php echo $diynav;?>
<?php } ?>
</div>
</div>
...
<li><a href="home.php?mod=space&amp;do=pm" id="pm_ntc" style="background-repeat: no-repeat; background-position: 0 50%;"><em class="prompt_news<?php if(empty($_G['member']['newpm'])) { ?>_0<?php } ?>"></em>Information</a></li>
<li><a href="home.php?mod=follow&amp;do=follower"><em class="prompt_follower<?php if(empty($_G['member']['newprompt_num']['follower'])) { ?>_0<?php } ?>"></em>New audience<?php if($_G['member']['newprompt_num']['follower']) { ?>(<?php echo $_G['member']['newprompt_num']['follower'];?>)<?php } ?></a></li>
<?php if($_G['member']['newprompt'] && $_G['member']['newprompt_num']['follow']) { ?>
<li><a href="home.php?mod=follow"><em class="prompt_concern"></em>I am concerned(<?php echo $_G['member']['newprompt_num']['follow'];?>)</a></li>
...
<li class="ignore_noticeli"><a href="javascript:;" onclick="setcookie('ignore_notice', 1);hideMenu('myprompt_menu')" title="Do not remind"><em class="ignore_notice"></em></a></li>
<?php } ?>
</ul>
<?php } if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?>
<div id="sslct_menu" class="cl p_pop" style="display: none;">
<?php if(!$_G['style']['defaultextstyle']) { ?><span class="sslct_btn" onclick="extstyle('')" title="Default"><i></i></span><?php } if(is_array($_G['style']['extstyle'])) foreach($_G['style']['extstyle'] as $extstyle) { ?><span class="sslct_btn" onclick="extstyle('<?php echo $extstyle['0'];?>')" title="<?php echo $extstyle['1'];?>"><i style='background:<?php echo $extstyle['2'];?>'></i></span>
<?php } ?>
</div>
<?php } if($_G['uid']) { ?>
<ul id="myitem_menu" class="p_pop" style="display: none;">
<li><a href="forum.php?mod=guide&amp;view=my">Post</a></li>
<li><a href="home.php?mod=space&amp;do=favorite&amp;view=me">Collect</a></li>
<li><a href="home.php?mod=space&amp;do=friend">Friend</a></li>
...
Please <br /><a class="xi2" href="member.php?mod=connect"><strong>complete account information</strong></a> or <a href="member.php?mod =connect&amp;ac=bind" class="xi2 xw1"><strong>Bind an existing account</strong></a><br />Use quick navigation
</div>
<?php } else { ?>
<div class="ptm pbw hm">
Please <a href="javascript:;" class="xi2" onclick="lsSubmit()"><strong>Sign in</strong></a> to use quick navigation<br />Don't have an account? <a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="xi2 xw1"><?php echo $_G['setting']['reglinkname'];?></a>
</div>
...
<div id="nv">
<a href="javascript:;" id="qmenu" onmouseover="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})">Quick Navigation</a>
...
$slist[forumfid] = <<<EOF
<li><a href="javascript:;" rel="curforum" fid="{$_G['fid']}" >This edition</a></li>
EOF;
...
$slist[forum] = <<<EOF
<li><a href="javascript:;" rel="forum" class="curtype">Post</a></li>
EOF;
?><?php } if(helper_access::check_module('blog') && $_G['setting']['search']['blog']['status'] && ($_G['group']['allowsearch'] & 4 || $_G['adminid'] == 1)) { ?><?php
$slist[blog] = <<<EOF
<li><a href="javascript:;" rel="blog">Log</a></li>
EOF;
?><?php } if(helper_access::check_module('album') && $_G['setting']['search']['album']['status'] && ($_G['group']['allowsearch'] & 8 || $_G['adminid'] == 1)) { ?><?php
$slist[album] = <<<EOF
<li><a href="javascript:;" rel="album">Photo album</a></li>
EOF;
...
?><?php } ?><?php
$slist[user] = <<<EOF
<li><a href="javascript:;" rel="user">User</a></li>
EOF;
?>
...
<td class="scbar_txt_td"><input type="text" name="srchtxt" id="scbar_txt" value="Enter search content" autocomplete="off" x-webkit-speech speech /></td>
<td class="scbar_type_td"><a href="javascript:;" id="scbar_type" class="xg1" onclick="showMenu(this.id)" hidefocus="true">Search</a></td>
<td class="scbar_btn_td"><button type="submit" name="searchsubmit" id="scbar_btn" sc="1" class="pn pnc" value="true"><strong class="xi2">Search</strong></button></td>
<td class="scbar_hot_td">
<div id="scbar_hot">
<?php if($_G['setting']['srchhotkeywords']) { ?>
<strong class="xw1">Hot search: </strong><?php if(is_array($_G['setting']['srchhotkeywords'])) foreach($_G['setting']['srchhotkeywords'] as $val) { if($val=trim($val)) { $valenc=rawurlencode($val);?><?php
